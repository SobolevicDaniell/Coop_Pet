...
namespace Game
{
    ...
    {
        [Inject(Optional = true)] private NetworkRunner _runner;                 // если биндишь сам раннер
        [Inject(Optional = true)] private NetworkRunnerProvider _runnerProvider; // если используешь провайдер
