...
namespace Game
{
    /// Универсальный доступ к InventorySlotState: id/count/state
    /// Работает независимо от регистра, полей/свойств и альтернативных имён.
    public static class InventorySlotStateAccessor
    {
        private static readonly System.Type T = typeof(InventorySlotState);

        // расширенный набор допустимых имён
